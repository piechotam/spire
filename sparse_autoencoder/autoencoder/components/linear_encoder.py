...
Code from https://github.com/neuroexplicit-saar/Discover-then-Name/blob/main/sparse_autoencoder/sparse_autoencoder/autoencoder/components/linear_encoder.py
"""
import math
