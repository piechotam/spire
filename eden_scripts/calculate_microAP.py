...
from metrics.metrics import create_ground_truth_dict, find_nearest_neighbors, micro_average_precision
...
if __name__ == "__main__":
    ...
    matched_pairs = find_nearest_neighbors(QUERY_EMBEDDINGS_PATH, REFERENCE_EMBEDDINGS_PATHS, args.model, ground_truth, args.batch_size, args.save_path)
